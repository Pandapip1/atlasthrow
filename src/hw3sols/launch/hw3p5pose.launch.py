"""Launch HW3 P5 w/ Full URDF at the specified pose

   ros2 launch hw3sols hw3p5pose.launch.py

This should start
  1) RVIZ, ready to view the robot
  2) The robot_state_publisher to broadcast the robot model
  3) The stripped-down trajectory code (HW3 P5 solution code)
     to specify the pose
...
def generate_launch_description():
    ...
    urdf = os.path.join(pkgdir('hw3sols'), 'urdf/fourDOFfull.urdf')
